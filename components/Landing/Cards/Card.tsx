...
function Card({ title, image, description }: Props) {
	return (
		<div className="hover:cursor-grab active:cursor-grabbing text-center bg-white dark:bg-dark-mainActive rounded-lg drop-shadow-xl dark:drop-shadow-[0_20px_13px_rgba(0,0,0,0.5)] max-w-xs h-auto md:max-w-max md:w-auto  aspect-[4/5] md:h-[35rem]   py-8 px-5 flex flex-col justify-between mb-4">
